...
const GroupChart = () => {
  ...
  return (
    <Container className="">
      <RootStyle className="text-center">
        <div>
          <h1 className="fw-bold">
            <span className="text-danger">Blood</span> Donors Analytics
          </h1>
          <span className="text-success fs-5">Bangladesh</span>
          <p className="text-secondary my-3">
            <small>
              Roll up your sleeves and contribute proactively in this noble
              cause. A drop of blood can save a life! Donate blood and get real
              blessings. Your droplets of blood may create an ocean of
              happiness.
            </small>
          </p>
        </div>
