                    ...
                    <div className="d-flex justify-content-between align-items-center container">
                        <div className="w-50">
                            <h1 className="text-start font-open-sens">
                                Fight <br />{" "}
                                <span style={{ color: "#e3376e" }}>
                                    {" "}
                                    Covid-19{" "}
                                </span>{" "}
                            </h1>
                            <h4 className="text-start font-lora my-5">
                                From 2020 we start a mission to provide free
                                medical consultation to those who are affected
                                with Covid-19 Lorem ipsum dolor sit amet
                                consectetur adipisicing elit. Ipsa, ducimus!
                            </h4>
                ...
                <Carousel.Item interval={3000}>
                    <div className="d-flex justify-content-between align-items-center container">
                        <div className="w-50">
                            ...
                            <h4 className="text-start font-lora my-5 ">
                                We Provide An Emergency Health Consultant Within
                                1 Hour to Our Premium Member
                            </h4>
                            <button className="btn-consult-banner">
