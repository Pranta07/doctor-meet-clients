...
const DoctorView = () => {
    ...
    const handleBookSubmit = (e: React.SyntheticEvent) => {
        ...
        //send review data to server
        fetch(
            `https://evening-peak-31569.herokuapp.com/api/v1/appointment/add`,
            {
                method: "POST",
                headers: {
                    "content-type": "application/json",
                        ...
                        <div className="my-5">
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-6 address-style ">
                                    ...
                                    <h5 style={{ color: "#0783b5" }}>Fee</h5>
                                    <p>BDT {doctor?.visit}</p>
                                </div>
                            </div>
                            <div className="my-5">
                                <h3 style={{ color: "#0783b5" }}>
