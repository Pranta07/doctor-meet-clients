...
const DiagnosticAppointmentForm = () => {
    ...
    const handleOnSubmit = (e) => {
        ...
        fetch(`https://floating-basin-02241.herokuapp.com/bookedDiagnosis`, {
            ...
            .then((data) => {
                if (data.insertedId) {
                    alert(
                        "Appointment is booked successfully. Now go to dashboard to pay"
                    );
    ...
    return (
        <RootStyle className="diagnostic-form-container mt-5 pt-5">
            <Container>
                <Row>
                        ...
                        <fieldset>
                            ...
                            <Row>
                                <Form.Group
                                    ...
                                    sm={12}
                                    xs={12}
                                    controlId="formGridContactPerson"
                                >
                                    <Form.Control
                                        onChange={handleOnChange}
                                        type="text"
