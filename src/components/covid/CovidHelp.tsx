            ...
            <div className="col-lg-6 my-0 p-5">
              <div>
                ...
                <p className="text-start py-3">
                  Completing the form online has been made simpler. It should
                  take no more than 20 minutes to complete. Once you have
                  received the text message, you can submit the form anytime
                  within 24 hours. If you do not submit the form within 72
                  hours, someone may call you and complete the case interview
                  over the phone.
                </p>
              </div>
              <Button
