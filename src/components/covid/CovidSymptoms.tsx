...
import symptoms from "../../aAssets/img/Symptoms-main.svg";
import "./CovidSymptoms.css";

const CovidSymptoms = () => {
  return (
    <>
      <section className="symptoms-section mb-5 pb-5" id="symptoms">
        <div className="container">
          ...
          <div className="row align-items-center">
            ...
            <div className="col-12 col-md-6 col-lg-6 ps-5">
              <h4 className="text-danger" style={{ fontWeight: 600 }}>
              ...
              <h4 className="text-warning" style={{ fontWeight: 600 }}>
