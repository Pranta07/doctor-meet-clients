                ...
                <div className="row d-flex justify-content-center align-items-center">
                    ...
                    <div className="col-lg-6 col-12 text-start ps-5">
                        <div className='d-flex flex-column'>
                            ...
                            <p className='health-care-provider-description'>Doctor Meet provides progressive, and affordable healthcare, accessible on mobile and online for everyone. To us, it’s not just work. We take pride in the solutions we deliver</p>
                        </div>
                        <button type="button" className="btn learn-more-button btn-outline-primary rounded-pill px-4">Learn more</button>
                    </div>
