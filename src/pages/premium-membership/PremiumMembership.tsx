...
const PremiumMembership: React.FC<Props> = ({ premiumMembership }) => {
    ...
    return (
        <Card className="premium-membership-card">
            <Card.Body>
                <Card.Title className="premium-membership-card-title text-center mb-5">
                ...
                <Card.Text className="text-center premium-member-card-text">
                    ...
                    <p>
                        <i className="fa fa-check"></i> Get Appointment Within
                        an Hour
                        <hr className="w-50 mx-auto" />
                    </p>
                    <p>
                        <i className="fa fa-check"></i> {pharmacyDiscount}%
                        Discount on Pharmacy
                        <hr className="w-50 mx-auto" />
                    </p>
                    <p>
                        <i className="fa fa-check"></i> {appointmentDiscount}%
                        Discount on an Appointment
                        <hr className="w-50 mx-auto" />
                    </p>
                    <p>
                        <i className="fa fa-check"></i> {labTestDiscount}%
