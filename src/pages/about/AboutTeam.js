...
import { Box, Stack, Card, Button, Container, Typography,CardMedia } from '@mui/material';
// _mock_
...
function MemberCard({ member }) {
  ...
  return (
    <Card key={name} sx={{ p: 1 }}>
      ...
      <CardMedia component="img" alt={name} src={avatar} ratio="1/1" sx={{ borderRadius: 1.5 }} />
